...
This repository contains the material for the Cloud ERP AI hands-on for using generative AI to build SAP Fiori applications.

## Overview

Welcome to the SAP Fiori tools generative AI hands-on.  In this session we will give you a step-by-step guide to building productive SAP Fiori applications using only generative AI.  You will learn how to create applications from business requirements, and also how you can use images or sketches of your application and see them converted into SAP Fiori applications.

The generated application will be built from the **SAP Cloud Application Programming Model**, and will coontain UI applications that support the **SAP Fiori Elements Framework**.  Furthermore, the generated applications will be fully compliant with **SAP Fiori tools** for further modifications.
...
- [Exercise 1 - Generate an SAP Fiori elements application from business requirements](exercises/ex1#exercise-1---generate-an-sap-fiori-elements-application-from-business-requirements)
...
- [Exercise 2 - Generate an SAP Fiori elements application from an image](exercises/ex2#exercise-2---generate-an-sap-fiori-elements-application-from-an-image)
...
- [Exercise 3 - Generate an SAP Fiori elements application using images and text](exercises/ex3#exercise-3---generate-an-sap-fiori-elements-application-using-images-and-text)
